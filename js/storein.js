...
document.addEventListener("DOMContentLoaded", function () {
    ...
    document.querySelectorAll(".item-box").forEach(box => {
        box.addEventListener("click", function () {
            ...
            const tag = this.querySelector(".tag") ? this.querySelector(".tag").outerHTML : "";
            const hiddenItems = JSON.parse(this.getAttribute("data-hidden-items") || "[]");
            ...
            modalItemBox.innerHTML = `
                ...
                <div class="text-box">
                    ...
                    <p>${description}</p>
                    ${hiddenItemsHTML}
                    <button class="price" onclick="window.location.href='cart.html'">${price}</button>
                </div>
            `;
            ...
            modalItemBox.innerHTML = `
                <div class="modal-content2">
                    ...
                    <div class="text-box2">
                        ...
                        <p>${description}</p>
                        ${hiddenItemsHTML}
                        <button class="price2" onclick="window.location.href='cart.html'">${price}</button>
                    </div>
                </div>
            `;
